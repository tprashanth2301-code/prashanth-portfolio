# Prashanth Terupelli Portfolio - Full Source Code Documentation
This document contains the complete source code for the Prashanth Terupelli Portfolio website, optimized for deployment on Vercel.
